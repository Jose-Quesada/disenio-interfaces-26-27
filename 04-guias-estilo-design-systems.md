...
Esta unidad se vincula directamente con el Resultado de Aprendizaje 3 del currículo del módulo 0615 Diseño de Interfaces Web, que establece que el alumno debe "aplicar guías de estilo y sistemas de diseño en la creación de interfaces web, utilizando herramientas de generación de estilos y frameworks de diseño, justificando su uso en cada caso". También se relaciona transversalmente con el RA1, que aborda la planificación de interfaces a partir de especificaciones de diseño, ya que los sistemas de diseño constituyen el puente entre la fase de planificación y la implementación técnica. El RA2, centrado en la creación de interfaces web utilizando lenguajes de marcas y hojas de estilo, encuentra en los tokens de diseño y las variables CSS una conexión metodológica directa con esta unidad. Asimismo, el RA4, relativo a la accesibilidad y usabilidad en interfaces, se ve reforzado por la incorporación de criterios de accesibilidad dentro de los sistemas de diseño, garantizando que todos los componentes cumplan con las pautas WCAG desde su concepción. Por último, el RA6, que trata sobre la documentación de interfaces, se materializa a través de las herramientas de documentación de sistemas de diseño como Storybook y Zeroheight.
