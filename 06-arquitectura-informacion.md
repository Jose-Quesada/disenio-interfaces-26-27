...
Esta unidad se vincula de manera directa y fundamental con el Resultado de Aprendizaje 1 del currículo del módulo 0615 Diseño de Interfaces Web, que establece que el alumno debe "planificar la creación de una interfaz web a partir de las especificaciones de diseño, utilizando herramientas de prototipado y wireframing, y documentando la estructura de la información". La Arquitectura de la Información constituye precisamente la fase de planificación y estructuración previa a cualquier diseño visual o implementación técnica. Los sitemaps, wireframes y user flows que el alumno aprenderá a crear son los entregables fundamentales de esta fase de planificación. La unidad también se relaciona con el RA3, sobre guías de estilo y sistemas de diseño, ya que la estructura informativa debe ser coherente con el lenguaje visual definido en la guía de estilo. El RA4, centrado en accesibilidad y usabilidad, encuentra en la AI su fundamento teórico: una arquitectura de la información bien diseñada es la base sobre la que se construye una experiencia usable y accesible. Por último, el RA6 sobre documentación de interfaces se nutre de los diagramas y esquemas (sitemaps, flujos, mapas de navegación) que constituyen la documentación estructural del proyecto.
